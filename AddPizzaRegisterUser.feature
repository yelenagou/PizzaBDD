Feature: 
As a Registered Authenticated customer
I want to Navigate to the add new pizza page
So I can create a new pizza and place an order

 Background: 
    Given registered customer user navigates to http://mypizzaurl.com/list.html:
